 ...
 */
public class FetchMovieDetails extends AsyncTask<String, Void,List< MovieDetails>> {
    ...
    private List< MovieDetails> getMovieDataFromJson(String jsonStr) throws JSONException {
